...
public class JwtUtility {
    ...
    private static final String SECRET_KEY = "ujjwal singh rawat ABFVSYGWUGDBUWBDW";
    ...
    public String extractEmail(String token) {
        try {
            ...
            Claims claim = Jwts.parserBuilder()
                    ...
                    .getBody();
            System.out.println("getting email => "+ claim);
    ...
    public boolean validationToken(String token, String userEmail) {
